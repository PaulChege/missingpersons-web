...
user.cases.create([{name: "JaneDoe",age:18,height: 1.7,weight: 60, body_type:"slim", location_last_seen:"Langata", date_last_seen:"10/10/2017",status: "solved",description: "...",reporter_rel: "Relative"}])
